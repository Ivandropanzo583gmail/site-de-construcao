...
import { FiMenu, FiX } from "react-icons/fi"; // Importar ícones de menu
      ...
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="hidden md:flex space-x-8">
          <ul className="flex space-x-24 text-sm font-semibold">
            <li className="text-red-600"><Link href="/">Home</Link></li>
            <li className='hover:text-gray-400'><Link href="#services" >Services</Link></li>
            <li className='hover:text-gray-400'><Link href="/about" ><a>About</a></Link></li>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          <ul className=" text-sm font-semibold text-center">
            <li className="text-red-600 block py-2 px-4"><Link href="/" >Home</Link></li>
            <li className='hover:text-gray-400 block py-2 px-4'><Link href="#services" >Services</Link></li>
            <li className='hover:text-gray-400 block py-2 px-4'><Link href="/about" >About</Link></li>
